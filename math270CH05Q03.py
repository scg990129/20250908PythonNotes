...
# --- Setup the plot ---
ax.set_title("Vector Cross Product: j × k = i", fontsize=16)
ax.set_xlim([-1.5, 1.5])
ax.set_ylim([-1.5, 1.5])
ax.set_zlim([-1.5, 1.5])
...
# Result vector i (1, 0, 0)
ax.quiver(0, 0, 0, 1, 0, 0, color='green', arrow_length_ratio=0.15, linewidth=3, label='j × k = i')

# --- Add labels to the vectors ---
ax.text(0, 1.1, 0, 'j', color='blue', fontsize=14)
ax.text(0, 0, 1.1, 'k', color='red', fontsize=14)
ax.text(1.1, 0, 0, 'i (Result)', color='green', fontsize=14)
